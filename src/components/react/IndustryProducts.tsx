        ...
        <div className={cn(
          ...
          {view === 'list' && (
            <div className="hidden md:grid grid-cols-12 gap-4 px-4 py-2 border-b border-slate-200 bg-slate-50 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
              ...
              <div className="col-span-3">CAS Number</div>
            ...
            >
              {view === 'grid' ? (
                ...
                <a href={`/products/${product.slug}`} className="grid grid-cols-1 md:grid-cols-12 gap-4 px-4 py-2 items-center z-10 w-full group">
                  ...
                  <div className="hidden md:block col-span-3 font-mono text-[12px] text-slate-600">{product.cas}</div>
                  ...
                  <div className="hidden md:flex col-span-2">
                    <div className="flex items-center gap-1 text-slate-400 group-hover:text-orange-600 transition-colors font-medium text-[12px]">
